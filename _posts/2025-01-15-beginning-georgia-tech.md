...
By implementing these strategies, I made the large amounts of data that came my way manageable. At any moment, I quickly could figure out what information was important for me to know. The system I built also encouraged me to have moments of rest so I could have the energy needed to work when doing so. Since adopting these practices, I found that I can sustain longer periods of focus and engage more deeply with not only the work itself but also my peers as every interaction was more deliberate. It also dawned on me that the application of this concept extends beyond program communications to lengthy developer language documentation reviews to dense research papers. This was such an important first lesson and I’m excited to see what else I learn throughout this program!

_Note: I'm very aware this is just a real-world implementation of a cache_ :)